...
const services = [
  {
    ...
    desc: 'Modern corporate office complexes designed for productivity, collaboration, and brand identity — from single-floor suites to multi-storey headquarters.',
    icon: '🏢',
  },
  {
    title: 'Retail Spaces',
    desc: 'High-footfall retail environments built to attract customers and maximise commercial potential with smart layouts and premium finishes.',
    icon: '🏪',
  },
  {
    title: 'Shopping Complexes',
    desc: 'Large-scale shopping malls and commercial plazas with robust structural engineering, efficient circulation, and modern amenities.',
    icon: '🛍️',
  },
  {
    title: 'Warehouses & Logistics',
    desc: 'Industrial-grade warehouses with optimised floor plans, loading docks, fire safety systems, and high-clearance structures.',
    icon: '🏭',
  },
  {
    title: 'Hospitals & Healthcare',
    desc: 'Compliant healthcare facilities built to NABH standards — OT suites, ICUs, patient wards, and diagnostic centres with infection-control design.',
    icon: '🏥',
  },
  {
    title: 'Educational Institutions',
    desc: 'Schools, colleges, and training centres designed for safety, natural light, acoustics, and inspiring learning environments.',
    icon: '🎓',
  },
  {
    title: 'Corporate Campuses',
    desc: 'Integrated campus developments with offices, cafeterias, parking, landscaping, and recreational zones for leading enterprises.',
    icon: '🏗️',
  },
  {
    title: 'Industrial Buildings',
    desc: 'Heavy-duty industrial structures — factories, processing plants, and manufacturing units built for operational efficiency and safety.',
    icon: '⚙️',
  },
];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                {['🏢 Office Buildings', '🏥 Healthcare', '🎓 Education', '🏭 Industrial'].map((item) => (
                  <div key={item} className="bg-[#F3F3F3] rounded-2xl p-6 flex flex-col items-center justify-center text-center gap-2 hover:shadow-md transition-shadow">
                    <span className="text-3xl">{item.split(' ')[0]}</span>
                    <span className="text-sm font-semibold text-[#1F3A5F]">{item.split(' ').slice(1).join(' ')}</span>
                  </div>
                ))}
              </div>
            </div>
