  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-end overflow-hidden" aria-label="Hero">
      ...
      <div className="absolute inset-0 z-0" aria-hidden="true">
        ...
        <div className="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-t from-black/60 to-transparent" style={{ zIndex: 3 }} />
        {/* Grain overlay */}
        <div className="grain-overlay absolute inset-0 opacity-[0.04] pointer-events-none" style={{ zIndex: 4 }} />
        {/* Scan line */}
          ...
          <div
            ...
            style={{
              ...
              style={{
                ...
                height: '3px',
                transition: prefersReducedMotion ? 'none' : 'width 400ms ease-in-out, opacity 400ms ease-in-out'
              }} />
