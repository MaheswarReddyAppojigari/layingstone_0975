...
const projects = [
  { name: 'Indoor Skating Rink', type: 'Project Concept', desc: 'Enclosed indoor skating rink with PP interlocking tile surface, perimeter boarding, safety padding, and LED lighting.' },
  { name: 'Roller Skating Facility', type: 'Proposed Facility', desc: 'Community roller skating facility with smooth PP tile surface, coloured lane markings, and spectator seating.' },
  { name: 'Skating Training Arena', type: 'Illustrative Project', desc: 'Dedicated skating training arena with FIBA-certified PP tile surface, safety enclosures, and professional lighting systems.' },
];
      ...
      <main>
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-[#1F3A5F]">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto pt-28 pb-20">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 leading-tight">Skating Rink</h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-[4/3]">
                <Image src="https://img.rocket.new/generatedImages/rocket_gen_img_1f27f33b0-1784878137580.png" alt="PP interlocking tile skating rink with perimeter boarding and lighting" fill className="object-cover" />
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#1F3A5F] mt-3">Skating Rink Facility Concepts</h2>
              <p className="text-gray-500 mt-3 max-w-xl mx-auto text-sm leading-relaxed">
                Illustrative project concepts representing the scope and type of skating rink infrastructure we design and build.
              </p>
            </div>
        ...
        <section className="py-20 bg-[#F3F3F3]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <p className="text-gray-500 mt-3 max-w-xl mx-auto text-sm leading-relaxed">Premium PP interlocking tile systems for all-weather skating rinks.</p>
            </div>
