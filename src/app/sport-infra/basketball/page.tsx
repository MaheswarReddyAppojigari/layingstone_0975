...
const products = [
{
  ...
  alt: 'PP interlocking tiles for outdoor basketball court',
  specs: [
  ...
  certifications: ['FIBA Certified', 'Labosport Certified', 'BWF Compliant'],
  highlight: 'Superior grip, shock absorption, FIBA-certified for outdoor courts'
},
{
  name: 'Acrylic Sports Flooring',
  image: "https://images.unsplash.com/photo-1701896153127-deeab65d8427",
  alt: 'Acrylic sports flooring for outdoor basketball court',
  specs: [
  ...
  certifications: ['FIBA Compliant', 'UV Resistant', 'Anti-slip'],
  highlight: 'Reliable outdoor multi-purpose surface with consistent ball bounce'
},
{
  name: 'PVC Sports Flooring',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_196d50468-1784878139241.png",
  alt: 'PVC sports flooring for indoor basketball court',
  specs: [
  { label: '4.5mm', value: 'Comfort & Grip' },
  { label: '6mm', value: 'Better Cushion' },
  { label: '7mm', value: 'High Performance' }],

  certifications: ['Indoor Use', 'Anti-slip', 'FIBA Compliant'],
  highlight: 'Premium indoor basketball surface with superior cushioning'
},
{
  name: 'Wooden Flooring',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_11a08be07-1768765571042.png",
  alt: 'Premium maple wooden flooring for professional basketball court',
  specs: [
  ...
  highlight: 'Elite indoor basketball surface — the gold standard for professional play'
}];


const ancillaryWorks = [
{ title: 'Fencing', desc: 'Perimeter fencing solutions for court security and ball containment.' },
{ title: 'Lighting Solutions', desc: 'LED floodlighting meeting FIBA lux requirements for competitive and recreational play.' },
{ title: 'Net & Backboard Installations', desc: 'FIBA-standard backboards, ring systems, and net installations.' },
{ title: 'Shell Construction', desc: 'Complete civil and structural shell construction for indoor basketball halls.' },
      ...
      <main>
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-[#1F3A5F]">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto pt-28 pb-20">
            ...
            <div className="inline-flex items-center gap-2 bg-[#C6A15B]/20 border border-[#C6A15B]/30 rounded-full px-4 py-1.5 mb-6">
              <span className="text-[#C6A15B] text-sm font-medium tracking-wide">FIBA Compliant</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 leading-tight">
              Basketball Courts
            </h1>
            <p className="text-white/70 text-lg max-w-2xl mx-auto leading-relaxed">
              FIBA-compliant basketball courts with premium PP interlocking tiles, acrylic, PVC, and wooden flooring — built for indoor and outdoor environments.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#F3F3F3]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <span className="text-[#C6A15B] font-semibold text-sm uppercase tracking-widest">About Basketball</span>
                <h2 className="text-3xl md:text-4xl font-bold text-[#1F3A5F] mt-3 mb-6">Courts Built for Performance at Every Level</h2>
                <p className="text-gray-600 leading-relaxed mb-5">
                  LayingStone Sports Infra constructs basketball courts that comply with FIBA (International Basketball Federation) standards. From outdoor community courts to professional indoor arenas, we deliver surfaces engineered for consistent ball bounce, superior grip, and player safety.
                </p>
                <p className="text-gray-600 leading-relaxed mb-5">
                  Our basketball court solutions serve schools, sports academies, residential communities, corporate campuses, clubs, and government sports facilities. We offer PP interlocking tiles, acrylic surfaces, PVC flooring, and premium wooden floors — each selected to match the specific performance requirements and environment of the project.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Every court is delivered as a complete turnkey project — from civil base construction and drainage to surface installation, line markings, backboard systems, fencing, and lighting.
                </p>
                <div className="mt-8 flex flex-wrap gap-3">
                  {['FIBA Certified', 'PP Interlocking', 'Wooden Flooring', 'Indoor & Outdoor', 'Turnkey Delivery']?.map((tag) =>
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-[4/3]">
                <Image
                  src="https://img.rocket.new/generatedImages/rocket_gen_img_11a08be07-1768765571042.png"
                  alt="Professional basketball court with premium flooring and backboard system"
                  fill
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#1F3A5F] mt-3">Basketball Court Flooring Solutions</h2>
              <p className="text-gray-500 mt-3 max-w-xl mx-auto text-sm leading-relaxed">
                FIBA-certified flooring systems for indoor and outdoor basketball courts at every performance level.
              </p>
            </div>
        ...
        <section className="py-20 bg-[#1F3A5F]">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Ready to Build Your Basketball Court?</h2>
