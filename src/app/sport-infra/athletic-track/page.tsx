...
const projects = [
  { name: 'Synthetic Athletic Track', type: 'Project Concept', desc: 'World Athletics-standard 400m synthetic PU track with lane markings, field event areas, and perimeter fencing.' },
  { name: 'Running Track', type: 'Proposed Facility', desc: 'School or institutional running track with PU surface, lane markings, and complete civil base construction.' },
  { name: 'Athletics Training Facility', type: 'Illustrative Project', desc: 'Comprehensive athletics training facility with track, field event zones, and spectator infrastructure.' },
];
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#1F3A5F] mt-3">Athletic Track Facility Concepts</h2>
              <p className="text-gray-500 mt-3 max-w-xl mx-auto text-sm leading-relaxed">Illustrative project concepts representing the scope and type of athletic track infrastructure we design and build.</p>
            </div>
